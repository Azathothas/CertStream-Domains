...
mkdir -p "$HOME/bin"
#btop
curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/btop" -o "$HOME/bin/btop" ; chmod +xwr "$HOME/bin/btop"
#croc
curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks/main/x86_64/croc" -o "$HOME/bin/croc" ; chmod +xwr "$HOME/bin/croc"
#eget
